...
class DatabaseService:
    ...
    def _handle_response(self, response: requests.Response, operation: str):
        ...
        if 200 <= response.status_code < 300:
            ...
            except ValueError: # Handle cases where response is successful but JSON is empty/invalid
    ...
    def create_project(self, name: str, user_id: str, description: Optional[str] = None, is_public: bool = False) -> Dict[str, Any]:
        payload = {
            "name": name,
            "user_id": user_id,
    ...
    def get_project(self, project_id: str) -> Dict[str, Any]:
        ...
        if isinstance(result, list) and len(result) > 0:
            ...
            raise Exception(f"Project not found: {project_id}") # More specific exception
    
    def list_projects(self, user_id: str, limit: int = 100, offset: int = 0) -> List[Dict[str, Any]]:
    ...
    def execute_custom_query(self, table: str, query_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
